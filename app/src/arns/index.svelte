<script>
  ...
  async function handleChange(e) {
    ...
    if (result.ok) {
      successData = {
        message: "Successfully changed tx id",
      };
      successDialog = true;
    } else {
      errorMessage = result.message;
...
<main>
  <section class="hero min-h-screen items-start">
    <div class="hero flex-col lg:flex-row-reverse w-full ">
      <div class="flex flex-col space-y-5 w-full">
        <div>
          <div class="flex-1 flex justify-center items-center space-x-8">
            <h2 class="text-2xl mb-2">
              <a class="link" href="https://ar.io/arns">ArNS</a>
            </h2>
            {#if $address}
          ...
          <div class="flex space-x-4 justify-center my-16">
            <label class="label text-white">Is subdomain available?</label>
            <input
          ...
          <div class="flex justify-center items-center">
            <div class="flex flex-col justify-center">
              ...
              >
              <p class=" text-white font-bold p-4">
                <strong>NOTE!</strong> Need a small amount of $AR in your wallet and enough $ARNS TEST Tokens
              </p>
            </div>
          </div>
          <div class="overflow-x-auto">
            ...
            {:else}
              <div class="alert alert-info">
                Connect to tx id to see or purchase subdomains.
              </div>
            {/if}
